...
const getNgoDonationSummary = async (req, res) => {
    ...
    try {
      ...
      WHERE dr.ngo_id = ?
    `, [ngoId]);
        const fundsReceivedResult = await (0, mysql_1.queryOne)(`
    ...
    `, [ngoId]);
        const fundsPendingResult = await (0, mysql_1.queryOne)(`
      SELECT COALESCE(SUM(drc.quantity_or_amount), 0) as total
      FROM donation_request_contributions drc
      INNER JOIN donation_requests dr ON drc.request_id = dr.id
      WHERE dr.ngo_id = ? 
    ...
    `, [ngoId]);
        ...
        const summary = {
            ...
            totalFundsCollected: parseFloat(((_a = fundsReceivedResult === null || fundsReceivedResult === void 0 ? void 0 : fundsReceivedResult.total) === null || _a === void 0 ? void 0 : _a.toString()) || '0') + parseFloat(((_b = fundsPendingResult === null || fundsPendingResult === void 0 ? void 0 : fundsPendingResult.total) === null || _b === void 0 ? void 0 : _b.toString()) || '0'),
            fundsReceived: parseFloat(((_c = fundsReceivedResult === null || fundsReceivedResult === void 0 ? void 0 : fundsReceivedResult.total) === null || _c === void 0 ? void 0 : _c.toString()) || '0'),
            fundsPending: parseFloat(((_d = fundsPendingResult === null || fundsPendingResult === void 0 ? void 0 : fundsPendingResult.total) === null || _d === void 0 ? void 0 : _d.toString()) || '0'),
...
const updateContributionStatus = async (req, res) => {
    ...
    `, [contributionId]);
      ...
      `, [contributionId]);
        ...
        try {
            const donorIdRow = await (0, mysql_1.query)('SELECT donor_id FROM donation_request_contributions WHERE id = ?', [contributionId]);
            const donorId = (_a = donorIdRow === null || donorIdRow === void 0 ? void 0 : donorIdRow[0]) === null || _a === void 0 ? void 0 : _a.donor_id;
            if (donorId) {
                await (0, notification_service_1.createAndEmitNotification)({
                    userId: donorId,
                    userType: 'DONOR',
            ...
            const admins = await (0, mysql_1.query)('SELECT id FROM admins');
            for (const admin of admins) {
                await (0, notification_service_1.createAndEmitNotification)({
                    userId: admin.id,
                    userType: 'ADMIN',
                    title: 'Contribution Status Updated',
                    message: `${(updatedContribution === null || updatedContribution === void 0 ? void 0 : updatedContribution.donor_name) || 'Donor'} contribution ${statusUpper === 'ACCEPTED' ? 'received' : 'not received'} by NGO`,
                    type: 'DONATION',
                    relatedEntityType: 'contribution',
                    relatedEntityId: contributionId,
                    metadata: { status: statusUpper }

...
const updateEmailTemplate = async (req, res) => {
    try {
        ...
        if (existing) {
            ...
            await (0, mysql_1.insert)('INSERT INTO email_templates (template_type, subject, body_html, is_default) VALUES (?, ?, ?, FALSE)', [templateType, subject.trim(), bodyHtml.trim()]);
        }
...
const restoreDefaultTemplate = async (req, res) => {
    try {
        ...
        if (existing) {
            ...
            await (0, mysql_1.insert)('INSERT INTO email_templates (template_type, subject, body_html, is_default) VALUES (?, ?, ?, TRUE)', [templateType, defaultTemplate.subject, defaultTemplate.bodyHtml]);
        }
        return (0, response_1.sendSuccess)(res, {
            templateType,
            subject: defaultTemplate.subject,
